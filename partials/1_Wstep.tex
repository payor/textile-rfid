...
W programie \emph{CST Microwave Studio} zaprojektowano  model anteny tekstylnej naramiennej. Do celów symulacji dla modelu ramienia przyjęto zgodnie z artykułem KKRRiT z 2013 roku \cite{Artykul} dla mięśni czyli w tym wypadku $\epsilon_{r}$ = 52 i $\sigma$ = 1,8.
