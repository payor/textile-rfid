...
\begin{figure}[h!]
	\centering
	    \includegraphics[width=15.5cm]{struktura płaska.jpg}
	    \caption{Podział tekstronicznych systemów transmisji}
\end{figure}
...
Przeprowadzono parametryzację struktury, aby uzyskać założone parametry anteny. Stopień dyskretyzacji został ustalony po 6 iteracjach. Rezultaty procesu doboru wymiarów anteny, można było obserwować na wykresach. Najlepsze wyniki posłużyły do ustalenia rozmiaru projektowanej anten, a pózniej wykonania prototypu. Impedancja wejściowa symulowanej anteny ustalona została na 38 \(\Omega\). Schemat struktury po parametryzacji i prototyp widoczny jest na Rys.4.1 i Rys. 4.2. Natomiast wymiary zestawiono w Tab. 4.1. 
