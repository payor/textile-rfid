...
\begin{table}[t]
\caption{Wymiary anteny}
\begin{center}
 \begin{tabular}{|c|c|p{4cm} | p{3cm} |} 
  \hline
		PARAMETR & WARTOŚĆ [mm]  \\ \hline 
		L & 130  \\ \hline    
		L1 & 55.5  \\ \hline 
		L2 & 59 \\ \hline
     	H & 30   \\ \hline
		...
		W & 3  \\ \hline
      	W2 & 17 \\ \hline
        długość podłoża & 15.5 \\ \hline
       szerokość podłoża & 7.5 \\ \hline
    \hline
   \end{tabular}
 \end{center}
\end{table}
...
\caption{Wymiary anteny}
\begin{center}
 \begin{tabular}{|c|c| p{4cm} | p{1.5cm} | p{1.5cm} |} 
  \hline
		RODZAJ ANTENY  & CZĘSTOTLIWOŚĆ [MHz]  POZIOM MOCY SYGNAŁU [dBM] \\ \hline 
		 POLARYZACJA POZIOMA  \\ \hline
		WZORCOWA  & 130  \\ \hline    
		MIERZONA TEKSTYLNA & 55.5  \\ \hline 
		WZORCOWA & 59 \\ \hline
     	MIERZONA TEKSTYLNA & 30   \\ \hline
      	H2 & 22  \\ \hline
     	D & 5  \\ \hline
       	D2 & 2   \\ \hline 
		W & 3  \\ \hline
